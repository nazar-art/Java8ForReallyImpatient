...
public class LongAdderDemo {
    ...
    public static void main(String[] args) {
        ...
        double elapsedTime = run(THREADS, ITERATIONS, counter::increment);
        ...
        elapsedTime = run(THREADS, ITERATIONS, atomic::incrementAndGet);
        ...
        elapsedTime = run(THREADS, ITERATIONS, adder::increment);
        ...
        elapsedTime = run(THREADS, ITERATIONS, () -> badCounter[0]++);
